 ...
 \end{enumerate} 
  ...
  \item[\textbf{C.}] \textbf{MCQs with One Correct Answer}\\
   \end{enumerate}
    ...
    \begin{enumerate} 
        \item If $f(x)=x^3+bx^2+cx+d$ and $0<b^2<c,$ then in $(-\infty,\infty)$ \hfill{\brak{2004S}}
        \begin{enumerate}
    ...
    \end{enumerate} 
      ...
      \item
      Consider the two curves $C_{1}:y^2=4x,$$C_{2}:x^2+y^2-6x+1=0.)$ Then,  \hfill{\brak{2008}}
     \begin{enumerate}
   ...
   \end{enumerate}    
     ...
     \item
     If $f: R \rightarrow R$ is a twice differentiable function such that $f''(x)>0$ for all $x \in R$ and $f\brak{\frac{1}{2}} = \brak{\frac{1}{2}},$ $f(1)=1,$ then
     \hfill{\brak{JEE Adv. 2017}}\\
     \begin{enumerate}
      \item $f'(1) \le 0$ 
      \item $0<f'(1) \le \frac{1}{2}$
      \item $\frac{1}{2} < f'(1) \le 1$ 
      \item $f'(1) > 1$
    \end{enumerate}
    \end{enumerate}
 \newpage
